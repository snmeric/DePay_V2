  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..shader =  LinearGradient(
              colors: [Color(0xff17B3A9).withOpacity(0.8), Color(0xff0945DF).withOpacity(0.8),],
...
class MyPainter2 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ...
      ..shader = LinearGradient(
              colors: [    const Color(0xffAF4F9C).withOpacity(0.8),
      const Color(0xffE53983).withOpacity(0.8),
      const Color(0xffFB848F).withOpacity(0.8)],
...
class MyPainter3 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..shader = LinearGradient(
              colors: [      Color(0xff7717B3).withOpacity(0.3),
      Color(0xffDF09CA).withOpacity(0.3)],
              begin: Alignment.topLeft,
              end: Alignment.bottomRight)
          .createShader(Rect.fromCircle(
        center: Offset(0, 0),
...
class MyPainter5 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..shader = LinearGradient(
              colors: [   Color(0xff72047B).withOpacity(0.7),
      Color(0xff6709DF).withOpacity(0.7)],
              begin: Alignment.topLeft,
              end: Alignment.bottomRight)
          .createShader(Rect.fromCircle(
        center: Offset(0, 0),
