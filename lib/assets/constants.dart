...
//Background
// const kBackgroundColor = Color(0xff171925);
// const kBackgroundSecondaryColor = Color(0xff242635);
...
TextStyle regularTextStyle = GoogleFonts.poppins(
    fontWeight: FontWeight.w400, color: kColorText, fontSize: 18,shadows: [
                Shadow(
                    offset: Offset(4, 2),
                    blurRadius: 5,
...
TextStyle mediumTextStyle = GoogleFonts.poppins(
    fontWeight: FontWeight.w600, color: kColorText, fontSize: 18,shadows: [
                Shadow(
                    offset: Offset(4, 2),
                    blurRadius: 5,
                    color: Color.fromRGBO(0, 0, 0, 1),
...
TextStyle largewhiteTextStyle = GoogleFonts.poppins(
    fontWeight: FontWeight.w600, color: kColorText, fontSize: 21,shadows: [
                Shadow(
                    offset: Offset(4, 2),
                    blurRadius: 5,
                    color: Color.fromRGBO(0, 0, 0, 1),
